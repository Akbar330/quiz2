...
<div class="container mt-5">
    <h2 class="mb-4">Pertanyaan Gacha (Pelajar)</h2>

    <a href="{{ route('pelajar.gacha') }}" class="btn btn-warning mb-4">🎲 Gacha Pertanyaan</a>

    @foreach ($questions as $question)
        <div class="card mb-4 shadow-sm">
            <div class="card-body">
                <form method="POST" action="{{ route('pelajar.answer') }}">
                    @csrf
