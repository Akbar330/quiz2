                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <!-- FIELD BARU: user_type -->
                            <div class="row mb-3">
                                <label for="user_type" class="col-md-4 col-form-label text-md-end">Tipe User</label>
                                <div class="col-md-6">
                                    <select id="user_type" class="form-control @error('user_type') is-invalid @enderror"
                                        name="user_type" required>
                                        <option value="">Pilih Tipe User</option>
                                        <option value="public" {{ old('user_type') == 'public' ? 'selected' : '' }}>Masyarakat</option>
                                        <option value="student" {{ old('user_type') == 'student' ? 'selected' : '' }}>Pelajar</option>
                                    </select>
                                    @error('user_type')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
